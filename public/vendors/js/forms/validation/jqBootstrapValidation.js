    ...
    var defaults = {
        ...
        methods: {
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    // create contacts container if not exists
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("pattern") !== undefined) {
                            message = "Not in the expected format<!-- data-validation-pattern-contacts to override -->";
                        ...
                        if ($this.attr("max") !== undefined || $this.attr("aria-valuemax") !== undefined) {
                            ...
                            message = "Too high: Maximum of '" + max + "'<!-- data-validation-max-contacts to override -->";
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "Too low: Minimum of '" + min + "'<!-- data-validation-min-contacts to override -->";
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "Too long: Maximum of '" + $this.attr("maxlength") + "' characters<!-- data-validation-maxlength-contacts to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Too short: Minimum of '" + $this.attr("minlength") + "' characters<!-- data-validation-minlength-contacts to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Not a valid email address<!-- data-validation-email-contacts to override -->";
                        ...
                        if ($this.attr("minchecked") !== undefined) {
                            message = "Not enough options checked; Minimum of '" + $this.attr("minchecked") + "' required<!-- data-validation-minchecked-contacts to override -->";
                        ...
                        if ($this.attr("maxchecked") !== undefined) {
                            message = "Too many options checked; Maximum of '" + $this.attr("maxchecked") + "' required<!-- data-validation-maxchecked-contacts to override -->";
                    ...
                    $.each(validatorNames, function (i, el) {
                        // Set up the 'override' contacts
                        var message = $this.data("validation" + el + "Message");
                        var hasOverrideMessage = !!message;
                        var foundValidator = false;
                        if (!message) {
                            message = "'" + el + "' validation failed <!-- Add attribute 'data-validation-" + el.toLowerCase() + "-contacts' to input to change this contacts -->";
                        }
        ...
        builtInValidators: {
            ...
            passwordagain: {
                ...
                type: "match",
                match: "password",
                message: "Does not match the given password<!-- data-validator-paswordagain-contacts to override -->"
            },
            positive: {
                name: "Positive",
                type: "shortcut",
            ...
            integer: {
                ...
                type: "regex",
                regex: "[+-]?\\d+",
                message: "No decimal places allowed<!-- data-validator-integer-contacts to override -->"
            },
            positivenumber: {
                name: "Positivenumber",
                type: "min",
                min: 0,
                message: "Must be a positive number<!-- data-validator-positivenumber-contacts to override -->"
            },
            negativenumber: {
                name: "Negativenumber",
                type: "max",
                max: 0,
                message: "Must be a negative number<!-- data-validator-negativenumber-contacts to override -->"
            },
            required: {
                name: "Required",
                type: "required",
                message: "This is required<!-- data-validator-required-contacts to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
                minchecked: 1,
                message: "Check at least one option<!-- data-validation-checkone-contacts to override -->"
            },
            number: {
                name: "Number",
                type: "number",
