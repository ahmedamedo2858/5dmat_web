...
//------------------------------------------------------------------------------
    ...
    var LobiboxBase = {
        ...
        /**
         * Set the contacts of messagebox
         *
         * @param {string} msg "new contacts of messagebox"
         * @returns {LobiboxBase}
         * @private
         */
...
//------------------------------------------------------------------------------
    ...
    LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
        ...
        isValid: function () {
            var me = this,
                $error = me.$el.find('.lobibox-input-error-contacts');

            if (me.$options.required && !me.getValue()){
                me.$input.addClass('invalid');
                if ($error.length === 0){
                    me.$el.find('.lobibox-body').append('<p class="lobibox-input-error-contacts">'+me.$options.errorMessage+'</p>');
                    me._position();
                    me.$input.focus();
                }
                return false;
...
//------------------------------------------------------------------------------
        ...
        var _createNotify = function () {
            ...
            // Create body, append title and contacts in body and append body in notification
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        messageHeight: 60           // Notification contacts maximum height
    };
